...
//Q13
let transports = ["united moterbike", "hyunda car", "bianchi bicycle"];
transports.forEach(transports => {
    console.log(`I like to own a ${transports}`);
});
//Q14
let Guest = ["hassan ", "ahmad ", "akhtar", "shakell"];
Guest.forEach(Guest => {
...
//Q16
let guests = ["haseeb", "marie curie", "charles darwin"];
...
//Q19
let guest = ["Albert Einstein", "Marie Curie", "Leonardo da Vinci", "Isaac Newton", "Charles Darwin"];
...
let new_user = ["User 6", "User7", "User8", "admin", "User9"];
...
//Q34
let pizzas = ["fajjita", "tikka", "peppreroni"];
